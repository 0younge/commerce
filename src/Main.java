...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        electProducts.add(new Product("Galaxy S25", 1200000, "최신 안드로이드 스마트폰", 0));
        ...
        Category electCategory = new Category("전자제품", electProducts);
        ...
        Category clothCategory = new Category("의류", clothProducts);
